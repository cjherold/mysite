		...
		questions: [
			{
				...
				answers: ['200,000 miles', '500,000 miles', '1,000,000 miles', '80,000 miles'],
			...
			},
			{
				...
				correctResponse:
					'Although Venus comes closer to Earth at times, it has a wide orbit. Mercury is actually closer on average.',
			},
			{
				question:
					'If you combined all the gold ever mined, it would cover the state of Main.',
				questionType: 'true-false',
				correctMatch: false,
				correctResponse:
					'False, all the gold ever mined would form a cube roughly 21 meters on each side.',
			},
			{
